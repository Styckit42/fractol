...
{
	mlx->zoom_mandel->cx = x / mlx->limit_mandel->coeffx + mlx->limit_mandel->xmin;
	mlx->zoom_mandel->cy = (y / mlx->limit_mandel->coeffy + mlx->limit_mandel->ymin);
	mlx->zoom_mandel->hx = (mlx->limit_mandel->xmax - mlx->limit_mandel->xmin) / 4;
	mlx->zoom_mandel->hy = (mlx->limit_mandel->ymax - mlx->limit_mandel->ymin) / 4;
