...
{
	mlx->zoom_julia->cx = x / mlx->limit_julia->coeffx + mlx->limit_julia->xmin;
	mlx->zoom_julia->cy = (y / mlx->limit_julia->coeffy + mlx->limit_julia->ymin);
	mlx->zoom_julia->hx = (mlx->limit_julia->xmax - mlx->limit_julia->xmin) / 4;
	mlx->zoom_julia->hy = (mlx->limit_julia->ymax - mlx->limit_julia->ymin) / 4;
